...
\psfrag{Z}[lb][cb]{\miniscule{\begin{tabular}{@{}l@{}}
   ...
   backgroud displays the proportions of the whole \\
...
\minisculey 
In each chart the two typologies are presented side by side, for both men and women over 60. The lightly shaded background represents the distribution for the populaiton as a whole. 
\vspace{0.5em}

The width of the two bars corresponds to the relative numbers of men and women over 60 years old, and their percentage is given underneath.
\vspace{0.5em}
...
\rput[bl](0.05,0.83) {\footnotesize  Mexico (2015)}
%\psframe(0,0)(1,1)
}
...
\rput[bl](0.05,0.83) {\footnotesize United States (2000)}
%\psframe(0,0)(1,1)
}
...
\rput[bl](0.05,0.83) {\footnotesize Nicaragua (2005)}
%\psframe(0,0)(1,1)
}
...
\rput[bl](0.05,0.83) {\footnotesize Panama (2010)}
%\psframe(0,0)(1,1)
}
...
\rput[bl](0.05,0.83) {\footnotesize Dominican Rep. (2010)}
%\psframe(0,0)(1,1)
}
...
\rput[bl](0.05,0.83) {\footnotesize Puerto Rico (2000)}
%\psframe(0,0)(1,1)
}
...
\rput[bl](0.05,0.83) {\footnotesize Brazil (2010)}
%\psframe(0,0)(1,1)
}
...
\rput[bl](0.05,0.83) {\footnotesize Armenia (2011)}
%\psframe(0,0)(1,1)
}
...
\rput[bl](0.05,0.83) {\footnotesize Kyrgyz Republic (2009)}
%\psframe(0,0)(1,1)
} 
\rput[bl](2,2.33){
\psfrag{A}[c][b]{\miniscule{\begin{tabular}{@{}c@{}}
...
\rput[bl](0.05,0.83) {\footnotesize Palestine (2007)}
%\psframe(0,0)(1,1)
} 
...
\rput[bl](0.05,0.83) {\footnotesize China (2000)}
%\psframe(0,0)(1,1)
} 
...
\rput[bl](0.05,0.83) {\footnotesize Mongolia (2000)}
%\psframe(0,0)(1,1)
} 
...
\rput[bl](0.05,0.83) {\footnotesize Romania (2002)}
%\psframe(0,0)(1,1)
} 
...
\rput[bl](0.05,0.83) {\footnotesize Portugal (2011)}
%\psframe(0,0)(1,1)
} 
\rput[bl](3,5.66){
\psfrag{A}[c][b]{\miniscule{\begin{tabular}{@{}c@{}}
...
\rput[bl](0.05,0.83) {\footnotesize Poland (2002)}
%\psframe(0,0)(1,1)
} 
\rput[bl](3,6.66){
\psfrag{A}[c][b]{\miniscule{\begin{tabular}{@{}c@{}}
...
\rput[bl](0.05,0.83) {\footnotesize Belarus (2009)}
%\psframe(0,0)(1,1)
} 
...
\rput[bl](0.05,0.83) {\footnotesize Ireland (2011)}
%\psframe(0,0)(1,1)
} 
...
\rput[bl](0.05,0.83) {\footnotesize Greece (2001)}
%\psframe(0,0)(1,1)
} 
...
\rput[bl](0.05,0.83) {\footnotesize Botswana (2011)}
} 
...
\rput[bl](0.05,0.83) {\footnotesize Kenya (2009)}
%\psframe(0,0)(1,1)
} 
...
\rput[bl](0.05,0.83) {\footnotesize Senegal (2002)}
%\psframe(0,0)(1,1)
} 
...
\rput[bl](0.05,0.83) {\footnotesize SouthAfrica (2011)}
%\psframe(0,0)(1,1)
} 
